  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        signal: {
          discovered: "hsl(var(--signal-discovered))",
          reviewed: "hsl(var(--signal-reviewed))",
          validated: "hsl(var(--signal-validated))",
          actionable: "hsl(var(--signal-actionable))",
          archived: "hsl(var(--signal-archived))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
